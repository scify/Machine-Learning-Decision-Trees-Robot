		...
		<div class="container h-100">
			<div class="row h-100">
					...
					<div class="container h-100 col-12 no-gutters p-0">
						<div class="row h-25 p-0 col-12 no-gutters p-0">
							<div class="h-100 col-12 p-0" v-if="decisionTree">
								<div
									:style="{
										backgroundImage: `url('${textBubbleImage}')`,
				...
				<div class="col-7 h-100 container d-flex justify-content-center flex-column element-container">
					...
					<div
						class="row d-flex justify-content-center align-content-center align-self-center box-bottom"
						v-if="element"
					>
						<Annotator
...
export default {
	...
	components: {
		...
		Annotator: () => import("./Annotator.vue"),
	},
	data() {
		return {};
	},
