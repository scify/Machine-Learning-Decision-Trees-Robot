			...
			<div class="row h-100">
				<div class="col-5 h-100">
					<div class="container h-100 col-12 no-gutters p-0">
						<div class="row h-25 p-0 col-12 no-gutters p-0"></div>
						<div class="row h-75">
							<div class="container h-100">
								<div class="row h-100 d-flex justify-content-center">
									<div
										class="h-100 col-11"
										:style="{
											backgroundImage: `url('${robotWithBoardImage}')`,
				...
				<div
					class="col-7 h-100 container d-flex justify-content-center flex-column element-container no-gutters"
				>
					...
					>
						<div class="back-btn align-self-center cursor-pointer" v-on:click="$emit('back')">
							{{ $t("back") }}
						</div>
						<div class="forget-btn align-self-center cursor-pointer" v-on:click="$emit('reset')">
							{{ $t("forget") }}
						</div>
						<div class="finish-btn align-self-center cursor-pointer" v-on:click="$emit('finish')">
							{{ $t("end") }}
						</div>
					</div>
				</div>
...
<script>
export default {
	props: ["images", "element", "robotText", "decisionTree"],
	components: {
		ElementPresentation: () => import("./ElementPresentation.vue"),
